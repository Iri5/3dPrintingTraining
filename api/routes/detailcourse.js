...
router.get('/', urlencodedParser, (req, res) => {
    ...
    let query = `SELECT 
                    mydb.test.id AS t_id, 
                    mydb.test.title AS t_title, 
                    mydb.course.title AS c_title,
                    mydb.course.description AS c_desc, 
                    mydb.course.start AS c_start, 
                    mydb.course.end AS c_end, 
                    mydb.course.id AS c_id
                FROM mydb.test 
                JOIN mydb.test_course 
                ON mydb.test.id = mydb.test_course.test_id 
                JOIN mydb.course 
                ON mydb.course.id = mydb.test_course.course_id 
                WHERE course_id = ?;`;
